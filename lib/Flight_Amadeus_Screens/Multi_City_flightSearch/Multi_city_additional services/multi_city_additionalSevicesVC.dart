...
class Multi_city_Add_OnsVC extends StatefulWidget {
  ...
  @override
  State<Multi_city_Add_OnsVC> createState() => _userDashboardState();
}

class _userDashboardState extends State<Multi_city_Add_OnsVC> {
  ...
  List rnd_convert_travelerPricingsArray = [];
  Map<String, dynamic> rnd_convert_Currency_PriceArray = {};
...
//Retrived values
  ...
  _retrieveValues() async {
    ...
    rnd_convert_Currency_PriceArray = jsonDecode(Retrived_Currency_PriceArray);
    print('rnd add ons convert_Currency_PriceArray....');
    print(rnd_convert_Currency_PriceArray);
    ...
    setState(() {
      ...
      for (var i in data) {
        rnd_convert_travelerPricingsArray.add(i);
      }
    });
    print('rnd price convert_travelerPricingsArray...');
    print(rnd_convert_travelerPricingsArray);
    ...
    print(rnd_convert_Currency_PriceArray);
    grandTotalprice = rnd_convert_Currency_PriceArray['grandTotal'];
    print('grandTotalprice...');
    print(grandTotalprice);

    var Additionalservices = rnd_convert_Currency_PriceArray['additionalServices'];
...
//@override
  ...
  Future<void> _postData() async {
          ...
          "flightOffers": [
            {
              ...
              // "oneWay": false,
              // "isUpsellOffer": false,
              // "lastTicketingDate": "2024-12-04",
              // "lastTicketingDateTime": "2024-12-04",
              ...
              //           "iataCode": "MAD",
              //           "terminal": "4",
              //           "at": "2024-12-09T09:50:00"
              //         },
              //         "arrival": {
              //           "iataCode": "CDG",
              //           "terminal": "3",
              //           "at": "2024-12-09T12:00:00"
              //         },
              //         "carrierCode": "IB",
              //         "number": "585",
              //         "aircraft": {
              ...
              //   }
              // ],
              //convert_Currency_PriceArray
              "price": rnd_convert_Currency_PriceArray,
              ...
              "travelerPricings": rnd_convert_travelerPricingsArray
    ...
    print('multi city add ons Details array....');
    ...
    Widget continueButton = TextButton(
      ...
      onPressed:  () async{
        ...
        await Navigator.of(context)
            .push(new MaterialPageRoute(builder: (context) => Multi_city_passengerlistVC()));
        setState((){
    ...
    return MaterialApp(
        ...
        home: Scaffold(
            appBar: AppBar(
              ...
              title: Text(
                  'Multi city Select Services', textAlign: TextAlign.center,
                                                          ...
                                                          children: [
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                String convert_travelerPricingJson = jsonEncode(rnd_convert_travelerPricingsArray);
