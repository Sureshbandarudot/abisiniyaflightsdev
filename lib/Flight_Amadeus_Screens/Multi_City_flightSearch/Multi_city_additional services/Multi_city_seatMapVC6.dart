...
void main() {
  runApp(const Multi_city_journey_seatmapVC6());
}

class Multi_city_journey_seatmapVC6 extends StatelessWidget {
  const Multi_city_journey_seatmapVC6({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('multi city  6th flight journey seat',textAlign: TextAlign.center,
