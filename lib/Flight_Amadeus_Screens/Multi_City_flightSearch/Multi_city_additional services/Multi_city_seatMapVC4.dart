...
import 'Multi_city_seatMapVC3.dart';
import 'Multi_city_seatMapVC5.dart';



void main() {
  runApp(const Multi_city_journey_seatmapVC4());
}

class Multi_city_journey_seatmapVC4 extends StatelessWidget {
  const Multi_city_journey_seatmapVC4({super.key});
...
//Retrived values
  ...
  _retrieveValues() async {
    ...
    print('back seat Retrived_Currency_PriceArray...');
...
//@override
    ...
    if (response.statusCode == 200) {
      ...
      for(var decksData in seatData) {
        ...
        if (seatID == '4'){
          ...
          //     print('exitrowscnt.....');
          //     print(exitrowscnt);
          //     rows = deckConfiguration['length'] - 2;
          //     //rows = 23;
          //
          //     print('rows...cnt');
          //     print(rows);
          ...
          //     print('exitrowscnt connect.....');
          //     print(exitrowscnt);
          //     rows = deckConfiguration['length'] - 7;
          //     // rows = 4;
          //
          //     scrollwidth = 550;
          //
  ...
  Future<void> _postData_seatmap_Price() async {
    ...
    Without_seatmap_str = prefs.getString('seatmapkey') ?? '';
    seatmap_str = prefs.getString('seatmapkey') ?? '';

    print('connect seatmap Without_seatmap_str1....');
    ...
    print('rnd backward journey Details array....');
        ...
        leading: BackButton(
          onPressed: () async{
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => Multi_city_journey_seatmapVC3()),
            );
          },
        ),
        title: Text('Multi_city 4th flight seat',textAlign: TextAlign.center,
                        ...
                        if(selectedseat == ''){
                          ...
                          if(seatID_cnt.length == 4) {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => Multi_city_journey_seatmapVC5()),
                            );
