...
void main() {
  runApp(const Rnd_trp_fourth_flight_journey_seatmap());
}

class Rnd_trp_fourth_flight_journey_seatmap extends StatelessWidget {
  const Rnd_trp_fourth_flight_journey_seatmap({super.key});
