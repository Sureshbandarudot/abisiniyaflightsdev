...
import 'ConnectedsecondFlight.dart';




void main() {
  runApp(const ConnectedFlight_thirdSegment());
}

class ConnectedFlight_thirdSegment extends StatelessWidget {
  const ConnectedFlight_thirdSegment({super.key});
...
//@override
    ...
    if (response.statusCode == 200) {
      ...
      for(var decksData in seatData) {
        ...
        if (seatID == '3'){
          ...
          //     print(exitrowscnt);
          //     rows = deckConfiguration['length'] - 6;
          //     // rows = 4;
          //
          //     scrollwidth = 550;
          //
  ...
  Future<void> _postData_seatmap_Price() async {
    ...
    //tempList = List<String>();
    //List<String> tempList = [];
    print('call third connect selected seat...');
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    Without_seatmap_str = prefs.getString('seatmapkey') ?? '';
    print('3rd connect seatmap Without_seatmap_str1....');
    print(Without_seatmap_str);
    ...
    //   "chargeableSeatNumber": selectedseat
    // };
    print('connect third convert_travelerPricingsArray....');
    print(seatmap_convert_travelerPricingsArray);
  ...
  Widget build(BuildContext context) {
    ...
    // final isSelected1 = seatnumberListtempArray.contains(seatLabelList[rows * cols + cols].toString());
    //
                                                      ...
                                                      onTap: (){
                                                        ...
                                                        setState(() {
                                                          ...
                                                          if(_isSelected){
                                                            ...
                                                            //var seatArray = [];
                                                            // seatArray.add(seatnumberListtempArray);
                                                            // print('bracket...');
                                                            // print(seatArray);
                                                            // print(seatnumberListtempArray);
                                                            // print(seatnumberListtempArray.length);
